        ...
        myChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Number of Restaurants per Cuisine'
                    }
                },
                scales: {
                    y: {
...
function createMyMap() {
    ...
    try {
        ...
        restaurants.forEach(function(restaurant, index) {
            ...
            const popupContent = `${restaurant.name}, ${restaurant.cuisine} Cuisine, Rating: ${restaurant.rating}`;
    ...
    try {
        ...
        gsap.fromTo('.restaurant-card', 
            ...
            // TO state (ending point)  
            {
                ...
                opacity:1, scale: 1, y:0, stagger:0.1, ease: "bounce.out"
            }
        );
