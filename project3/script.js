...
import showStats, { createMyMap } from './editable_js/template_stats.js';
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    document.getElementById("btn-stats").onclick = () => {
      ...
      createMyMap(data) //implements map data after map has been initalized runtime error occurrs here
    };
